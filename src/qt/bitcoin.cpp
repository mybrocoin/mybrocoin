...
static CSplashScreen *splashref;
...
int main(int argc, char *argv[])
{
   ...
   public:
    ...
    if (GetBoolArg("-splash", true) && !GetBoolArg("-min"))
    {
         ...
         //CSplashScreen* splash = new CSplashScreen(aSplashImage);
         splash.show();
    
        // splash.showMessage(QString("Processing"), Qt::AlignTop |       Qt::AlignLeft, Qt::white);
