#############################################################################
# Makefile for building: mariobroscoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: mer. 15. janv. 20:12:11 2014
# Project:  mariobroscoin-qt.pro
# Template: app
# Command: c:/Qt/4.8.5/bin/qmake.exe -o Makefile mariobroscoin-qt.pro
#############################################################################
...
Makefile: mariobroscoin-qt.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -o Makefile mariobroscoin-qt.pro
...
clean: debug-clean release-clean FORCE
	-$(DEL_FILE) C:/litecoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/litecoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/litecoin/src/leveldb/libleveldb.a: FORCE
	cd C:/litecoin/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/litecoin/src/leveldb/libleveldb.a && ranlib C:/litecoin/src/leveldb/libmemenv.a
